...
const
  ...
  function DirectInput8Create (hinst : THandle; dwVersion : LongWord;
           const riidltf : TGUID; out ppvOut; punkOuter : IUnknown) : HResult; stdcall;

implementation

const
  DInputDLL = 'DInput8.dll';

function DirectInput8Create; external DInputDLL name 'DirectInput8Create';
